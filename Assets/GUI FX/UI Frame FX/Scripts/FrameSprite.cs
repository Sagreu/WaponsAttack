...
namespace GUIFX
{
    ...
    [ExecuteInEditMode]
    public class FrameSprite : MonoBehaviour
    {
        [SerializeField]
        ...
        private void Initialize()
        {
            ...
            {
                // Check if we own this mesh
                if (m_MeshFilter.sharedMesh.name != "FrameSpriteMesh")
                {
                    m_Mesh = new Mesh();
                    m_Mesh.name = "FrameSpriteMesh";
        ...
        private void UpdateUVOffset()
        {
            ...
            // Sprites/Default shader does not support mainTextureOffset, so we update UVs in the mesh
            RebuildMesh();
        }
        ...
        private void UpdateMaterialWrapMode()
        {
            ...
            // Access sharedMaterial to avoid creating instance in Editor just for checking
            ...
            {
                if (m_Sprite.texture.wrapMode != TextureWrapMode.Repeat)
        ...
        private void UpdateMaterial()
        {
            ...
            // If no material assigned, try to find default
            if (mat == null)
            {
                // Attempt to load default sprite material
                // Note: Resources.GetBuiltinResource is not easily available, assume user assigns one or we find one
            ...
            if (m_Sprite != null && mat != null)
            {
                ...
                // Ensure Repeat
                if (mat.mainTexture != null) mat.mainTexture.wrapMode = TextureWrapMode.Repeat;
            }
        }
        ...
        public void RebuildMesh()
        {
            ...
            // Sprite bounds are relative to pivot. min/max are adequate.
            ...
            for (int i = 0; i <= m_SegmentCount; i++)
            {
                ...
                AddVertex(outerPos, new Vector2((float)i / m_SegmentCount, 0));
                AddVertex(innerPos, new Vector2((float)i / m_SegmentCount, 1));
            }
        ...
        private void AddVertex(Vector2 position, Vector2 uv)
        {
            ...
            if (m_Sprite != null && m_Sprite.texture != null)
            {
                ...
                // Apply offset manually to simulate UV scrolling
                finalUV.x += m_UVOffset;
